...
import { cambiarDisponibleController, cargarPaseadorCuidadorController, enviarMailController, listarPaseadoresCuidadoresController, puntuarPCController } from "../controllers/paseadoresycuidadores";
...
PaseadoresCuidadoresRouter.put("/puntuar-pc", checkJWT, checkRol, puntuarPCController)