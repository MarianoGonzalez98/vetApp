    ...
    onMount(async () => {
            ...
            if ($user?.rol==='cliente'){
                ...
                .then((apiResponse) => {
                    ...
                    console.log(perrosCliente);
                });
                
                let perrosOptions = perrosCliente.map( (perro) => {
                    return {
                        label:`${perro.nombre} (Raza ${perro.raza})`,
                        value:perro.id
                    }
                });
                console.log(perrosCliente);
...
<div class="container mt-2 mb-10 h-full mx-auto flex justify-center items-center">
    <div class="w-6/12">
        ...
        <form class="space-y-2 mt-5 mb-5 max-w-md" action="">
    ...
    <!-- si es veterinario -->
        ...
        <hr class="!border-t-2" />
            ...
            <form class="space-y-2 mt-3 mb-5 max-w-md">
        ...
        {/if}
        <button class="btn rounded-lg variant-filled-primary mt-10">Crear publicación de adopción</button>
    </div>
