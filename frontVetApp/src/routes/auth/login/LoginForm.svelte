...
<div class="container h-full mx-auto flex justify-center items-center">
    <form on:submit|preventDefault={handleLogin} class="space-y-2">
        ...
        <input bind:value={email} class="input" type="text" title="Ingrese un mail valido" placeholder="Ingrese su email" name="email" pattern={emailPatternFactory} required>
