<script lang="ts">
	...
	async function onConfirm() {
		await fetch(`${backendURL}/busquedas/marcar-encontrado`,{
                method:'POST',
                headers:{
    ...
    const perroMarcadoEncontradoModal: ModalSettings = {
        type: "alert",
        title: "Publicación marcada dueño encontrado",
        body: "Se ha marcado correctamente dueño encontrado a la publicación seleccionada",
        buttonTextCancel: "Ok",
...
{#if $modalStore[0]}
	...
	<div class="modal-example-form {cBase}">
		...
		<article>¿Está seguro de marcar el perro {publicacion.nombrePerro} como dueño encontrado?</article>
