<script lang="ts">
	...
	// Form Data
	const formData = {
		nombre: datosParaContacto.nombreContacto,
		apellido: datosParaContacto.apellidoContacto,
		telefono: datosParaContacto.telefonoContacto,
		email: datosParaContacto.emailContacto,
	};
